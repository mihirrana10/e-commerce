<head>
    ...
    <meta name="description" content="James Allen - Bootstrap eCommerce Template">
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>template/user/assets/images/icons/favicon.ico">
    <meta name="apple-mobile-web-app-title" content="James Allen">
    <meta name="application-name" content="James Allen">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>template/user/assets/vendor/line-awesome/line-awesome/line-awesome/css/line-awesome.min.css">
    <!-- Plugins CSS File -->
