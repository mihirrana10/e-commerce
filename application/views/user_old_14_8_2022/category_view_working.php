...
<body>
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index.html" class="logo">
                            <!--<img src="<?php echo base_url(); ?>template/user/assets/images/logo.png" alt="Molla Logo" width="105" height="25">-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/menu/banner-2.jpg" alt="Banner">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="<?php echo base_url(); ?>template/user/assets/images/products/cart/product-1.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="<?php echo base_url(); ?>template/user/assets/images/products/cart/product-2.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-5.jpg" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-5-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-5-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-7.jpg" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <span class="product-label label-new">New</span>
                                                <a href="product.html">
                                                    <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-8.jpg" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-8-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-8-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-9.jpg" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-9-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-9-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-9-3-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-11-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-11-2-thumb.jpg" alt="product desc">
                                                    </a>

                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-11-3-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="<?php echo base_url(); ?>template/user/assets/images/products/product-12.jpg" alt="Product image" class="product-image">
                                                </a>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                <img src="<?php echo base_url(); ?>template/user/assets/images/logo.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
    ...
    <script src="<?php echo base_url(); ?>template/user/assets/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo base_url(); ?>template/user/assets/js/jquery.hoverIntent.min.js"></script>
    <script src="<?php echo base_url(); ?>template/user/assets/js/jquery.waypoints.min.js"></script>
    <script src="<?php echo base_url(); ?>template/user/assets/js/superfish.min.js"></script>
    <script src="<?php echo base_url(); ?>template/user/assets/js/owl.carousel.min.js"></script>
    <script src="<?php echo base_url(); ?>template/user/assets/js/wNumb.js"></script>
    ...
    <script src="<?php echo base_url(); ?>template/user/assets/js/nouislider.min.js"></script>
    <!-- Main JS File -->
