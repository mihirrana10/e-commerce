...
<table style="width: 70%;border-radius: 2%;">
   <tr>
      <td class="hero" style="background-image: url(); background-size: 600px; height: 148px;background-repeat: no-repeat;" valign="middle">
   ...
   <tr>
      <td>
         <p>Hi..!!</p>
         <p>Your bag of joy, containing the products you picked will arrive soon, We know that you can't wait to get your hands on it, so we've begun prepping for it right away.<p>
...
<table style="width:70%;/*width:800px*/;margin-bottom: 20px;border-radius: 2%;">
   <thead>
      <th style="background-color: #95A5A6;font-size:20px">
   ...
   <tr>
      <td style="width: 50%">
         <!--<address>-->
            ...
            Email: <font style="text-decoration:none;color:#333333;"><?php echo $order_data_row[0]->order_billing_email; ?></font>
         <!--</address>-->
      </td>
      <td style="width: 50%">
         <!--<address>-->
            ...
            Email: <font style="text-decoration:none;color:#333333;"><?php echo $order_data_row[0]->order_shipping_email; ?></font>
         <!--</address>-->
      </td>
   </tr>
</table>
                                                         ...
                                                         <tr >
                                                            ...
                                                            <td>
                                                               <h3 class="product-title">
                                                                     <a href="#" style="text-decoration:none;color:#333333;font-size:16px"><?php echo $order_detail_row->product_name; ?></a>
                                                                     <br>
                                                            ...
                                                            <td class="price-col" style="vertical-align: top;padding-top:70px;font-size:18px;padding-right:30px;padding-left:10px"><i class="icon-rupee"></i>Rs. <?php echo $order_detail_row->product_selling_price*$order_detail_row->product_qty; ?></td>
...
<table class="table"  style="width:70%;/*width:800px*/;border-radius: 2%;">
              <tbody><tr>
                <th style="width:25%;float:right;padding:5px;font-size:20px;"><strong><a href=#  style="text-decoration:none;color:#333333">Subtotal : </a></strong></th>
                <td style="padding:5px;text-align:right;padding-right:50px;font-size:16px;"><i class="fa fa-inr"></i> Rs. <?php echo $order_data_row[0]->order_amount; ?></td>
              </tr>
              <?php 
              ...
              if($order_data_row[0]->order_coupon_id!=0)
              {
                ...
                ?>
                 <tr>
                  <th style="width:25%;float:right;padding:5px;;font-size:20px;"><strong><a href=#  style="text-decoration:none;color:#333333">Coupon Code</a></strong>
                    <br>
                  ...
                  <td style="padding:5px;text-align: right;padding-right:50px;font-size:16px;"><i class="fa fa-inr"></i> - Rs. <?php echo $order_data_row[0]->order_coupon_discount_amount; ?></td>
                 </tr>
                <?php
              }
              ?>
              ...
              <tr>
                <th  style="width:25%;float:right;padding:5px;font-size:20px;"><strong><a href=#  style="text-decoration:none;color:#333333">Shipping : </a></strong></th>
                <td style="padding:5px;text-align: right;padding-right:50px;font-size:16px;"><i class="fa fa-inr"></i> + Rs. <?php echo $order_data_row[0]->order_shipping_amount; ?></td>
              </tr>
              <?php 
              if($order_data_row[0]->order_giftbox_charge!=0)
              {
                ?>
                <tr>
                  <th style="color:red;width:25%;float:right;padding:5px;font-size:20px;"><i class="fa fa-gift"></i><strong>
                  <a href=#  style="text-decoration:none;color:#333333"> Gift Box Packing Charge :</a></strong></th>
                  <td style="padding:5px;text-align: right;padding-right:50px;font-size:16px;"><i class="fa fa-inr"></i> + Rs. <?php echo $order_data_row[0]->order_giftbox_charge; ?></td>
                </tr>
                <?php
              }
              ?>
              ...
              if($order_data_row[0]->order_cod_charge!=0)
              {
                ?>
                <tr>
                  <th style="color:red;width:25%;float:right;padding:5px;font-size:20px;"><i class="fa fa-money"></i><strong><a href=#  style="text-decoration:none;color:#333333"> COD Charge : </a></strong></th>
                  <td style="padding:5px;text-align: right;padding-right:50px;font-size:16px;"><i class="fa fa-inr"></i> + Rs. <?php echo $order_data_row[0]->order_cod_charge; ?></td>
                </tr>
                <?php
              }
              ?>
              <tr>
                <th  style="width:28%;float:right;padding:5px;font-size:20px;"><strong>Final Total : </strong></th>
                <td style="padding:5px;font-size:16px;text-align: right;padding-right:50px"><i class="fa fa-inr"></i> Rs. <?php echo $order_data_row[0]->order_final_amount; ?></td>
              </tr>
            </tbody></table>

<table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"  style="width:70%;/*width:800px*/;border-radius: 2%;background: #95A5A6;margin-top: 70px">
   <tbody>
      <!--<tr>
