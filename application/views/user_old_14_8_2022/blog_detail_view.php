            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-3">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>user/blogs">Blogs</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo $blog_row[0]->blog_title; ?></li>
                    </ol>
                </div><!-- End .container -->
                        ...
                        <div class="col-lg-9">
                            <article class="entry single-entry">
                                <figure class="entry-media">
                                    <img src="<?php echo base_url().'files/admin/blog/'.$blog_row[0]->blog_image; ?>" alt="image desc">
                                ...
                                <div class="entry-body">
                                    ...
                                    <h2 class="entry-title">
                                        <?php echo $blog_row[0]->blog_title; ?>
                                    </h2><!-- End .entry-title -->
                                    ...
                                    <div class="entry-content editor-content"><?php echo $blog_row[0]->blog_content; ?></div>
